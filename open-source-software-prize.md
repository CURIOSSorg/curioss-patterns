...
1. **Scholarly Impact**: Measure using field-normalized metrics like the [Field Citation Ratio](https://help.dimensions.ai/en/articles/9780801) (FCR) to account for disciplinary differences.
